...
namespace Tarea_Backend.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<AmericaCustomers> AmericaCustomers { get; set; }
        public virtual DbSet<Categories> Categories { get; set; }
        public virtual DbSet<CategorySalesFor1997> CategorySalesFor1997 { get; set; }
        public virtual DbSet<ClientesPaises> ClientesPaises { get; set; }
        ...
        public virtual DbSet<ProductosArribaPromedio> ProductosArribaPromedio { get; set; }
        ...
        public virtual DbSet<VentasOrders> VentasOrders { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AmericaCustomers>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("AmericaCustomers");
            ...
            modelBuilder.Entity<ClientesPaises>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Clientes_Paises");
            ...
            modelBuilder.Entity<ProductosArribaPromedio>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductosArribaPromedio");
            ...
            modelBuilder.Entity<VentasOrders>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VentasOrders");
            ...
            modelBuilder.Entity<VentasProductos>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VentasProductos");
